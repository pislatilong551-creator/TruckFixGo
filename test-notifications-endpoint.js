...
async function testNotificationsEndpoint() {
  ...
  try {
    ...
    const notificationQuery = `
      INSERT INTO notifications (user_id, type, title, message, priority, expires_at)
      VALUES ('${userId}', 'system', 'Test Notification', 'This is a test notification', 'medium', NOW() + INTERVAL '7 days')
      RETURNING id;
    `;
