...
export default function ContractorDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex flex-col gap-3 sm:gap-4">
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <Badge className={`${tierColors[contractor?.performanceTier || 'bronze']} text-white flex-shrink-0 text-xs sm:text-sm px-2 py-1 sm:px-3`}>
            ...
            <div className="flex flex-wrap items-center gap-2">
              {/* Online/Offline Toggle - Mobile Optimized */}
              <div className={`flex items-center gap-2 px-3 py-1.5 sm:py-2 rounded-lg border text-sm sm:text-base ${
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 p-3 sm:p-4 pb-2">
              <CardTitle className="text-xs sm:text-sm font-medium truncate">Today's Earnings</CardTitle>
              <DollarSign className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-muted-foreground flex-shrink-0" />
            </CardHeader>
            <CardContent className="p-3 sm:p-4 pt-0">
              <div className="text-lg sm:text-xl md:text-2xl font-bold truncate" data-testid="text-today-earnings">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 p-3 sm:p-4 pb-2">
              <CardTitle className="text-xs sm:text-sm font-medium truncate">Jobs Today</CardTitle>
              <TrendingUp className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-muted-foreground flex-shrink-0" />
            </CardHeader>
            <CardContent className="p-3 sm:p-4 pt-0">
              <div className="text-lg sm:text-xl md:text-2xl font-bold" data-testid="text-jobs-today">
                {metrics?.todayJobs || 0}
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground mt-1 truncate">
                Week: {metrics?.weekJobs || 0}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 p-3 sm:p-4 pb-2">
              <CardTitle className="text-xs sm:text-sm font-medium truncate">Rating</CardTitle>
              <Star className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-muted-foreground flex-shrink-0" />
            </CardHeader>
            <CardContent className="p-3 sm:p-4 pt-0">
              <div className="flex items-center gap-1">
                <span className="text-lg sm:text-xl md:text-2xl font-bold" data-testid="text-rating">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="p-3 sm:p-4 pt-0">
              <div className="text-lg sm:text-xl md:text-2xl font-bold" data-testid="text-response-time">
                {contractor?.averageResponseTime || 0}m
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground mt-1 truncate">
                Avg response
              </p>
                            ...
                            {showAcceptReject && (
                              <div className="flex flex-col xs:flex-row gap-2 mt-4">
                                <Button
                                  variant="default"
                                  size="sm"
                                  className="bg-green-600 hover:bg-green-700 h-11 text-sm font-medium flex-1"
                    ...
                    <Card key={job.id} className={`border-l-4 ${job.jobType === 'emergency' ? 'border-l-orange-600' : 'border-l-blue-600'}`}>
                      <CardContent className="p-4">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex flex-col xs:flex-row gap-2 ml-0 xs:ml-4 mt-2 xs:mt-0">
                            <Button
                              variant="outline"
                              size="sm"
      ...
      {/* Invoice Editing Dialog - Mobile Optimized */}
      <Dialog open={showInvoiceDialog} onOpenChange={setShowInvoiceDialog}>
        <DialogContent className="w-[calc(100vw-2rem)] max-w-4xl max-h-[90vh] overflow-y-auto mx-4 p-4 sm:p-6">
          <DialogHeader>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="h-9 px-3 py-2 bg-muted rounded-md flex items-center font-medium text-sm">
                              ${(item.quantity * item.unitPrice).toFixed(2)}
                            </div>
                          </div>
                        </div>
